...
var _writeVersionToHtml = require("./write-version-to-html");
_writeVersionToHtml.writeVersionToHtml();
const initialState = _basicSetup.EditorState.create({
    ...
    extensions: [
        //vim(),
        _extension.blockLevelExtension(),
...
},{"@codemirror/basic-setup":"6nyFJ","./extension":"h7XP8","./write-version-to-html":"hivpp"}],"6nyFJ":[function(require,module,exports) {
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@codemirror/tooltip":"iwWKb","@codemirror/panel":"5l4Kc","@codemirror/gutter":"9zb6V","@codemirror/rangeset":"2SfPZ","crelt":"kpxRX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h7XP8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _extension = require("./extension");
parcelHelpers.exportAll(_extension, exports);

},{"./extension":"gvp0E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gvp0E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addBlockOnNewLine", ()=>addBlockOnNewLine
);
parcelHelpers.export(exports, "blockLevelExtension", ()=>blockLevelExtension
);
var _state = require("@codemirror/state");
var _dotWidget = require("./dot-widget");
var _findBlockLevelOfLine = require("./find-block-level-of-line");
var _handleChangeWithinBlockLevel = require("./handle-change-within-block-level");
var _keymap = require("./keymap");
var _theme = require("./theme");
var _validateCursorPosition = require("./validate-cursor-position");
const addBlockOnNewLine = _state.EditorState.transactionFilter.of((transaction)=>{
    ...
    transaction.changes.iterChanges((fromA, toA, fromB, toB, text)=>{
        ...
        for(let lineNumber = fromLine.number; lineNumber <= toLine.number; lineNumber++){
            ...
            const blockLevelOfLine = _findBlockLevelOfLine.findBlockLevelCharacterIndentationOfLine(line.text);
            if (blockLevelOfLine <= 0) {
                const shouldBlockLevel = _findBlockLevelOfLine.findBlockLevelOfLineNumberInDocument(doc, lineNumber);
                const numOfIndentationSpaces = line.text.length - line.text.trimLeft().length;
                const missingSpaces = shouldBlockLevel - numOfIndentationSpaces - 2;
                if (missingSpaces > -2) changes.push({
                    from: line.from,
...
function blockLevelExtension(_options = {
}) {
    return [
        // TODO there is a bug that changes precedence -> have to change order of extensions with that patch
        _dotWidget.dotWidgetViewPlugin,
        _validateCursorPosition.validateCursorPosition,
        addBlockOnNewLine,
        _handleChangeWithinBlockLevel.handleChangeWithinBlockLevel,
        _theme.dotTheme,
        _keymap.blockLevelKeymap, 
    ];
}

},{"./keymap":"cAEd8","./theme":"jgAvC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handle-change-within-block-level":"fvakk","./validate-cursor-position":"EXIWZ","@codemirror/state":"80zPS","./find-block-level-of-line":"c0i9q","./dot-widget":"I7mxi"}],"cAEd8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "blockLevelKeymap", ()=>blockLevelKeymap
);
var _view = require("@codemirror/view");
const blockLevelKeymap = _view.keymap.of([
    {
        key: "Tab",
        preventDefault: true,
...
function _dispatchBlockCommand(view, mode) {
    const changes = [];
    const lines = view.state.selection.ranges.map((range)=>view.state.doc.lineAt(range.from)
    );
    for (const line of lines){
        if (mode === "increase") changes.push({
            from: line.from,
            insert: "  "
        });
        else if (mode === "decrease") changes.push({
            from: line.from,
            to: line.from + 2
        });
        else throw new Error("Unhandled mode: " + mode);
    }
    if (!changes.length) return false;
    view.dispatch({
        changes
...
},{"@codemirror/view":"fBkgq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jgAvC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "dotTheme", ()=>dotTheme
);
var _basicSetup = require("@codemirror/basic-setup");
const dotTheme = _basicSetup.EditorView.baseTheme({
    ".cm-dot": {
        height: "1.3ch",
        width: "1.3ch",
        backgroundColor: "#bbb",
...
},{"@codemirror/basic-setup":"6nyFJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fvakk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleChangeWithinBlockLevel", ()=>handleChangeWithinBlockLevel
);
var _basicSetup = require("@codemirror/basic-setup");
var _findBlockLevelOfLine = require("./find-block-level-of-line");
const handleChangeWithinBlockLevel = _basicSetup.EditorState.transactionFilter.of((transaction)=>{
    const { doc  } = transaction.startState;
    const changes = [];
    transaction.changes.iterChanges((fromA, toA, fromB, toB, text)=>{
        const fromLine = doc.lineAt(fromA);
        // const toLine = doc.lineAt(toA);
        const fromLevel = _findBlockLevelOfLine.findBlockLevelOfLineNumberInDocument(transaction.startState.doc, fromLine.number);
        if (fromA === fromLine.from && fromA === toA && text.lines === 1 && !text.line(1).text.trim().length) // whitespace got inserted at beginning of line
        // => level increase
        // TODO for child block increase parent block only
        // console.log("level increase");
        return transaction;
        if (fromB === toB && text.lines === 1 && toA - fromLine.from < fromLevel) // whitespace deleted in indentation
        // => level decrease
...
},{"@codemirror/basic-setup":"6nyFJ","./find-block-level-of-line":"c0i9q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c0i9q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BLOCK_LEVEL_TEXT_PATTERN", ()=>BLOCK_LEVEL_TEXT_PATTERN
);
/**
 ...
 * @param lineNumber
 * @returns
 */ parcelHelpers.export(exports, "findBlockLevelOfLineNumberInDocument", ()=>findBlockLevelOfLineNumberInDocument
);
parcelHelpers.export(exports, "findBlockLevelCharacterIndentationOfLine", ()=>findBlockLevelCharacterIndentationOfLine
);
const BLOCK_LEVEL_TEXT_PATTERN = "- ";
function findBlockLevelOfLineNumberInDocument(doc, lineNumber) {
    for(let currentLineNumber = lineNumber; currentLineNumber >= 1; currentLineNumber--){
        const blockLevel = findBlockLevelCharacterIndentationOfLine(doc.line(currentLineNumber).text);
        if (blockLevel > 0) return blockLevel;
    }
    return 0;
}
function findBlockLevelCharacterIndentationOfLine(lineText) {
    const index = lineText.indexOf(BLOCK_LEVEL_TEXT_PATTERN);
    if (index >= 0) return index + 2;
    return 0;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"EXIWZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "validateCursorPosition", ()=>validateCursorPosition
);
var _state = require("@codemirror/state");
var _findBlockLevelOfLine = require("./find-block-level-of-line");
const validateCursorPosition = _state.EditorState.transactionFilter.of((transaction)=>{
    const doc = transaction.newDoc;
    let selectionChange = undefined;
    for (const { head , anchor  } of transaction.newSelection.ranges){
        const headLine = doc.lineAt(head);
        const headBlockLevel = _findBlockLevelOfLine.findBlockLevelOfLineNumberInDocument(doc, headLine.number);
        const headBlockEndIndex = headLine.from + headBlockLevel;
        const anchorLine = doc.lineAt(anchor);
        const anchorBlockLevel = _findBlockLevelOfLine.findBlockLevelOfLineNumberInDocument(doc, anchorLine.number);
        const anchorBlockEndIndex = anchorLine.from + anchorBlockLevel;
        let newHead = head;
        let newAnchor = anchor;
        if (head <= headBlockEndIndex) newHead = headBlockEndIndex;
        if (anchor <= anchorBlockEndIndex) newAnchor = anchorBlockEndIndex;
        if (newHead !== head || newAnchor !== anchor) selectionChange = {
            anchor: newAnchor,
            head: newHead
        };
    }
...
},{"@codemirror/state":"80zPS","./find-block-level-of-line":"c0i9q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"I7mxi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "dotWidgetViewPlugin", ()=>dotWidgetViewPlugin
);
var _view = require("@codemirror/view");
class DotWidget extends _view.WidgetType {
    constructor(level){
        super();
        this.level = level;
    }
...
const dotWidgetViewPlugin = _view.ViewPlugin.fromClass(class {
    update(update) {
        ...
        for (const { from , to  } of update.view.visibleRanges){
            ...
            for(let lineNumber = fromLine.number; lineNumber <= toLine.number; lineNumber++){
                ...
                if (blockMarkerIndex >= 0) tempDecos.push(_view.Decoration.replace({
                    widget: new DotWidget(blockMarkerIndex),
                    inclusiveStart: true
                }).range(// line.from,
                line.from + blockMarkerIndex, line.from + blockMarkerIndex + 2));
            }
        }
        this.decorations = _view.Decoration.set(tempDecos);
    }
    constructor(){
...
},{"@codemirror/view":"fBkgq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hivpp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "writeVersionToHtml", ()=>writeVersionToHtml
);
var _versionGen = require("./version.gen");
function writeVersionToHtml() {
    const versionEl = document.getElementById("version");
    if (versionEl) versionEl.textContent = _versionGen.version;
}

},{"./version.gen":"53YJd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"53YJd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8wcER","h7u1C"], "h7u1C", "parcelRequireda86")
